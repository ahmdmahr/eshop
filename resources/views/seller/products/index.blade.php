        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Products <a href="{{route('vendor.products.create')}}" class="btn btn-sm btn-outline-secondary"><i class="icon-plus"></i> Create Product</a></h2>
                    <ul class="breadcrumb float-left">
                        <li class="breadcrumb-item"><a href="{{route('vendor.dashboard')}}"><i class="icon-home"></i></a></li>                            
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- {{ $item->photo }}  --}}
                                        <td>
                                            <img src="{{$item->images->first()->url??null}}" alt="product image" style="max-height:150px;
                                            max-width:150px">
                                        </td>
                                        <td>{{$item->price}}$</td>
                                        <td>{{$item->discount}}%</td>
                                        ...
                                        <td>
                                            <a href="{{route('vendor.products.show',$item->id)}}" data-toggle="tooltip" class="btn btn-sm btn-outline-secondary mr-2" title="add attribute" data-placement="bottom"><i class="fas fa-plus-circle"></i></a>
                                            ...
                                            <a href="{{route('vendor.products.edit',$item->id)}}" data-toggle="tooltip" class="btn btn-sm btn-outline-primary mr-2" title="view" data-placement="bottom"><i class="fas fa-edit"></i></a>

                                            <form  action="{{route('vendor.products.destroy',$item->id)}}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
...
<script>
    $('input[name=toogle]').change(function(){
        ...
        // alert(mode);
        $.ajax({
            url:"{{ route('vendor.products.status') }}",
            type:"POST",
            data:{
                _token:'{{ csrf_token() }}',
                'id':id
