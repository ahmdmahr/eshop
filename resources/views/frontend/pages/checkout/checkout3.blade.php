...
@section('content')
    ...
    <div class="checkout_area section_padding_100">
        <div class="container">
            <form action="{{route('user.checkout3.store')}}" method="POST">
                @csrf
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="checkout_pagination d-flex justify-content-end mt-30">
                        <a href="{{route('user.checkout2')}}" class="btn btn-primary mt-2 ml-2">Go Back</a>
                        <button type="submit"class="btn btn-primary mt-2 ml-2">Final Step</a>
                    </div>
                </div>
            </div>
           </form>
