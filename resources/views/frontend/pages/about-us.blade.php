        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6">
                <div class="about_us_content pb-5 pb-lg-0">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <img src="{{asset($about_us->image3)}}" alt="About Us">
                        </div>
                        <div class="col-6">
                            <img src="{{asset($about_us->image4)}}" alt="About Us">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-6">
                <div class="about_us_content pl-0 pl-lg-5">
                    <h5>{{$about_us->heading}}</h5>
                    <p>{!!html_entity_decode($about_us->content)!!}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.2s">
                    <h2><span class="counter">{{$about_us->years_of_experience}}</span>+</h2>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.4s">
                    <h2><span class="counter">{{$about_us->happy_customers}}</span>+</h2>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.6s">
                    <h2><span class="counter">{{$about_us->parteners}}</span>+</h2>
                    <h5>Parteners</h5>
                </div>
            </div>
            <!-- Single Cool Facts -->
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.8s">
                    <h2><span class="counter"></span>{{$about_us->growth}}</h2>
                    <h5>Growth</h5>
                </div>
            </div>
        </div>
