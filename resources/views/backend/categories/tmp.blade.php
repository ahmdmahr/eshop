...
<head>
<title>:: Lucid University :: Add Students</title>
<meta charset="utf-8">
            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="events.html" class="icon-menu d-none d-sm-block d-md-none d-lg-block"><i class="icon-calendar"></i></a>
                        </li>
                        <li>
                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="add-students.html"><i class="icon-users"></i> <span>Students</span></a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Add Students</h2>
                        <ul class="breadcrumb">
