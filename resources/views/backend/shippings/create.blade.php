        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Add Shippings Mehtods</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"><i class="icon-home"></i></a></li>                            
                        <li class="breadcrumb-item">Shippings Mehtods</li>
                        <li class="breadcrumb-item active">Add Shipping Mehtod</li>
                    </ul>
                </div> 
            </div>
        </div>
                        ...
                        <form action="{{route('admin.shippings.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Shipping Method" name="shipping_method" value="{{old('shipping_method')}}">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
