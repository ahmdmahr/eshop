                        ...
                        <form action="{{route('admin.currencies.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Currency Name" name="name" value="{{old('name')}}">
                                </div>
                            </div> 
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <lable for="">Symbol<span class="text-danger">*</span></lable>
                                    <input type="text" class="form-control" placeholder="Currency Symbol" name="symbol" value="{{old('symbol')}}">
                                </div>
                            </div> 
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <lable for="">Exchange Rate<span class="text-danger">*</span></lable>
                                    <input type="number" step="any" class="form-control" placeholder="1usd = 50egp" name="exchange_rate" value="{{old('exchange_rate')}}">
                                </div>
                            </div> 
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <lable for="">Code<span class="text-danger">*</span></lable>
                                    <input type="text" class="form-control" placeholder="USD" name="code" value="{{old('code')}}">
                                </div>
                            </div> 
