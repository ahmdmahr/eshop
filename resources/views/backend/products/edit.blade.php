                        ...
                        <form action="{{route('admin.products.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="additional_info" name="additional_info" class="form-control" placeholder="Write some text...">{{$product->additional_info}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <lable for="">Retrun & Cancellation</lable>
                                    <textarea id="return_and_cancellation" name="return_and_cancellation" class="form-control" placeholder="Write some text...">{{$product->return_and_cancellation}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
