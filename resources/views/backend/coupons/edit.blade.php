                        ...
                        <form action="{{route('admin.coupons.update',$coupon->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="New@123" name="code" value="{{$coupon->code}}">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <lable for=""> Value <span class="text-danger">*</span></lable>
                                    <input type="text" class="form-control" placeholder="10% or 10.00$" name="value" value="{{$coupon->value}}">
                                </div>
                            </div>
